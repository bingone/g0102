...
import dao.BD.daoBDplancontractdatail;
import dao.DT.daoDTDate;

public class servBDplancontractdatailIns extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public servBDplancontractdatailIns() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
		      //
				...
				voBDplancontractdatail voplancontractdetail = new voBDplancontractdatail();
				voplancontractdetail.setContractNo(request.getParameter("contractNo").trim());
				voplancontractdetail.setPlanNo(request.getParameter("planNo"));
...
//					e.printStackTrace();
//				}
				Boolean flag = new daoBDplancontractdatail().insBDplancontractdatail(voplancontractdetail);
				if (flag != null){
